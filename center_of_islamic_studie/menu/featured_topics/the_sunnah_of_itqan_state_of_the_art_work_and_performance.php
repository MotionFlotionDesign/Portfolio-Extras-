			...
			<?php include('../../menu/topic/featured-topic.php'); ?>
      		...
      		<section class="long-text">
        		<article class="long-text-body">
          		...
          		<div class="col-md-12"> 
					<p><strong>Note: The reference of all the hadith and Qur'anic verses is available in the Solution to the Muslim Crisis, written by F. Burhan.</strong></p>
...
<p>This verse tells us that Allah's work is done with itqan. In Islam, quality work has a spiritual flavor because of its association with Allah, the Almighty. This divine touch adds to and colors the word itqan with beauty, art, and perfection.</p> 
...
<blockquote>"The Prophet (p) sent 'Amr ibn al'As as the leader of an expedition. Among others in the expedition were Abu Bakr and 'Umar ibn al Khattab. When they reached the designated place, 'Amr ordered that no fire be lit. The order upset 'Umar, who started walking toward 'Amr. Abu Bakr, however, stopped 'Umar and told him to calm down, since the Prophet (p) would not have chosen 'Amr had he not been the most knowledgeable to lead the expedition."</blockquote>
